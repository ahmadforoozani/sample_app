...
class UserTest < ActiveSupport::TestCase
  ...
  test "gender validation " do
    invalid_genders = %w[lfemale Malle mard zan]
    invalid_genders.each do |invalid_gender|
      @user.gender= invalid_gender
      assert_not @user.valid?, "#{invalid_gender.inspect} should be invalid"
  end
end
...
test "gender should not be more than 6 character" do
    @user.gender = "a" * 7
    assert_not @user.valid?
  end
